...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDAq7MrCR1A2qIShmjbtLHSKjcEIEBEEwM"></script>
...
<div class="right_col" role="main">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Nội dụng:</label>
                <div class="col-sm-10">
                    <p>
                        <textarea  name="noidung"  id="noidung" value=""  class="form-control ck_editor" ><?=@$row['noidung']?></textarea>
                    </p>
                </div>
            </div>
