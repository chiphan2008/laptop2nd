...
<div class="right_col" role="main">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        @foreach($rs_slide as $r)
                        <tr>
                          <td><input type="checkbox" name="chon[]" id="chon" value="{{$r['id']}}"></td>
                          <td>{{$r['ten']}}</td>
                          <td><img src="{{asset('public/images/slider/'.$r['urlhinh'])}}" height="100" /></td>
              ...
              <div class="col-md-12">
              <a type="button" href="{{asset($ADMIN_ROUTE.'/slide/form')}}" class="btn btn-success">Thêm mới</a>
